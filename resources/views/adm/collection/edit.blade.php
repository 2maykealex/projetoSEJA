    	...
    	<div class="col-md-8 bg-light py-3">
			...
			<form action="#" method="POST" class="pb-3 pt-3 bg-white px-3">
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="disabledTextInput" placeholder="{{$collectionEdit->id}}" disabled>
				</div>
				<div class="form-group">
				    <label>DESCRIÇÃO</label>   
				    <input type="text" class="form-control" id="name" name="name" placeholder="{{$collectionEdit->name}}">
				</div>
				@endforeach
		    	<div class="clearfix">
