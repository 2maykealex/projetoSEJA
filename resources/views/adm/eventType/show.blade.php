			...
			<form class="pb-3 pt-3 bg-white px-3">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-5">
					    ...
					    <input type="text" class="form-control" placeholder="{{date('d/m/Y', strtotime($eventType->created_at))}}" disabled>
					</div>
					<div class="form-group col-md-5">
					    <label for="updated_at">DATA DE ALTERAÇÃO</label> 
					    <input type="text" class="form-control" placeholder="{{date('d/m/Y', strtotime($eventType->updated_at))}}" disabled>
					</div>
				</div>
