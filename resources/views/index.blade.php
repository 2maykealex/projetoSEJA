...
@section('content')
    ...
    <!--navbar-->
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow mb-2 py-3">
            <div class="container">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid" style="padding-right: 0; padding-left: 0;">
                                    <div class="d-flex justify-content-center">
                                        <img src="{{asset('storage/img/posts/'. $post->image)}}" class="img-fluid col-sm-12 col-md-6 px-0" alt="Responsive image">  
                                    </div>
                                    <div class="container">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-10 col-md-6 blog-main">
                                                <div class="blog-post">
